...
\label{sec:orgaba3ef2}
\subsection*{Gráfico de la serie temporal y su correlograma}
\label{sec:org1eeb548}
...
\label{sec:org5c9cca4}
\subsection*{Primer modelo}
\label{sec:orgdf7038a}
...
\label{sec:orgcb271e6}
\subsection*{Primer modelo}
\label{sec:org94598f4}
...
\end{verbatim}
\section*{Preguntas}
\label{sec:orgb1242a7}

\subsection*{Pregunta 1}
\label{sec:orgcb204b1}
...
los resultados de los apartados \hyperref[sec:org174ae6d]{Datos en nivel del consumo de petroleo en Grecia}, \hyperref[sec:orgaba3ef2]{Datos en nivel de la popularidad del nombre Óscar en EEUU} y
\hyperref[sec:orga62a61f]{Contraste de cointegración}.

(\hyperref[sec:org8f22ef7]{Respuesta 1})
\subsection*{Pregunta 2}
\label{sec:orgab9d603}

Discuta si las series temporales \texttt{ConsumoPetroleo} y \texttt{FrecuenciaOscar}
están cointegradas, a partir de los resultados del apartado \hyperref[sec:orga62a61f]{Contraste de cointegración}.

(\hyperref[sec:orgedbd935]{Respuesta 2})
\subsection*{Pregunta 3}
\label{sec:orgb94d845}

¿Contradice la \hyperref[sec:orgcb271e6]{Regresión en primeras diferencias} la posibilidad de que
están relacionados el consumo de petroleo en Grecia y la popularidad
del nombre de pila Oscar en los EEUU?

(\hyperref[sec:org5fe107a]{Respuesta 3})
\subsection*{Pregunta 4}
\label{sec:org3bfd5b4}

Los listados de la \hyperref[sec:org5c9cca4]{Regresión del consumo de petroleo sobre la popularidad del nombre Óscar} y la \hyperref[sec:orgcb271e6]{Regresión en primeras diferencias}
...
(\hyperref[sec:orgf6c4126]{Respuesta 4})
\subsection*{Pregunta 5}
\label{sec:orgc42d59b}
...
(\hyperref[sec:org9bd4016]{Respuesta 5})
\subsection*{Pregunta 6}
\label{sec:org803ac4d}

En la Sección \hyperref[sec:org174ae6d]{Datos en nivel del consumo de petroleo en Grecia}
aparecen dos modelos univariantes. Compare los resultados he indique
si alguno de ellos es preferible y por qué.

(\hyperref[sec:org53402f0]{Respuesta 6})
\subsection*{Pregunta 7}
\label{sec:org1e156cc}

En la Sección \hyperref[sec:orgaba3ef2]{Datos en nivel de la popularidad del nombre Óscar en EEUU} aparecen dos modelos univariantes. Compare los resultados he
indique si alguno de ellos es preferible y por qué.

(\hyperref[sec:org1e156cc]{Pregunta 7})
\subsection*{Pregunta 8}
\label{sec:org6b190a5}

¿Cuáles de los modelos de más arriba considera aceptables? ¿O qué
mejoras sugeriría para ellos?

(\hyperref[sec:org1a77a4d]{Respuesta 8})

\newpage
\section*{Respuestas}
\label{sec:org15a6dad}

\subsection*{Respuesta 1}
\label{sec:org8f22ef7}
...
\item \hyperref[sec:orgdd9f0f3]{Estimación de un primer modelo univariante para la serie de consumo de petroleo}: El modelo univariante estimado tiene una raíz AR
aproximadamente igual a \(1\).

\item \hyperref[sec:org776b087]{Estimación de un primer modelo univariante para la serie de popularidad del nombre Óscar}: El modelo univariante estimado tiene
una raíz AR aproximadamente igual a \(1\).

\item \hyperref[sec:orga62a61f]{Contraste de cointegración}: Los test ADF calculados en las etapas 1
y 2 no rechazan la hipótesis (raíz unitaria) con p-valores
superiores al 0.4
\end{itemize}

(\hyperref[sec:orgcb204b1]{Pregunta 1})
\subsection*{Respuesta 2}
\label{sec:orgedbd935}
...
(\hyperref[sec:orgab9d603]{Pregunta 2})
\subsection*{Respuesta 3}
\label{sec:org5fe107a}
...
Sorprendentemente, en la \hyperref[sec:orgcb271e6]{Regresión en primeras diferencias} la
...
decir, \uline{la \hyperref[sec:orgcb271e6]{Regresión en primeras diferencias} no contradice la
...
(\hyperref[sec:orgb94d845]{Pregunta 3})
\subsection*{Respuesta 4}
\label{sec:orgf6c4126}

\begin{description}
\item[{Primer modelo para datos en nivel}] (\hyperref[sec:org5c9cca4]{Regresión del consumo de petroleo sobre la popularidad del nombre Óscar}): Todos los
...
\item[{Primer modelo para datos en primeras diferencias}] (\hyperref[sec:orgcb271e6]{Regresión en primeras diferencias}): El único coeficiente significativo es la
...
(\hyperref[sec:org3bfd5b4]{Pregunta 4})
\subsection*{Respuesta 5}
\label{sec:org9bd4016}


\begin{description}
\item[{Segundo modelo para datos en nivel}] (\hyperref[sec:org5c9cca4]{Regresión del consumo de petroleo sobre la popularidad del nombre Óscar}): El segundo modelo
...
\begin{description}
\item[{Segundo modelo para datos en primeras diferencias}] (\hyperref[sec:orgcb271e6]{Regresión en primeras diferencias}): El segundo modelo incluye un nuevo regresor
...
(\hyperref[sec:orgc42d59b]{Pregunta 5})
\subsection*{Respuesta 6}
\label{sec:org53402f0}
...
(\hyperref[sec:org803ac4d]{Pregunta 6})
\subsection*{Respuesta 7}
\label{sec:orgda19482}
...
(\hyperref[sec:org6b190a5]{Pregunta 8})
\end{document}
