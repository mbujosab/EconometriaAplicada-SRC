...
\label{sec:org0dce84b}
\subsection*{Gráfico de la serie temporal y su correlograma}
\label{sec:orge0cd78d}
...
\label{sec:orgacc1102}
\subsection*{Primer modelo}
\label{sec:org21d513c}
...
\label{sec:org5b16206}
\subsection*{Primer modelo}
\label{sec:orgf5d7618}
...
\end{verbatim}
\section*{Preguntas}
\label{sec:org565f26d}

\subsection*{Pregunta 1}
\label{sec:org2b72ce9}
...
los resultados de los apartados \hyperref[sec:org1231ebc]{Datos en nivel del consumo de petroleo en Grecia}, \hyperref[sec:org0dce84b]{Datos en nivel de la popularidad del nombre Óscar en EEUU} y
\hyperref[sec:orgaed05fc]{Contraste de cointegración}.

(\hyperref[sec:org374e8e9]{Respuesta 1})
\subsection*{Pregunta 2}
\label{sec:org9102b43}

Discuta si las series temporales \texttt{ConsumoPetroleo} y \texttt{FrecuenciaOscar}
están cointegradas, a partir de los resultados del apartado \hyperref[sec:orgaed05fc]{Contraste de cointegración}.

(\hyperref[sec:orgebd9f8b]{Respuesta 2})
\subsection*{Pregunta 3}
\label{sec:org7c844dc}

¿Contradice la \hyperref[sec:org5b16206]{Regresión en primeras diferencias} la posibilidad de que
están relacionados el consumo de petroleo en Grecia y la popularidad
del nombre de pila Oscar en los EEUU?

(\hyperref[sec:org84d1472]{Respuesta 3})
\subsection*{Pregunta 4}
\label{sec:org4ace36f}

Los listados de la \hyperref[sec:orgacc1102]{Regresión del consumo de petroleo sobre la popularidad del nombre Óscar} y la \hyperref[sec:org5b16206]{Regresión en primeras diferencias}
...
(\hyperref[sec:org860031e]{Respuesta 4})
\subsection*{Pregunta 5}
\label{sec:org4fe6f95}
...
(\hyperref[sec:org2599647]{Respuesta 5})
\subsection*{Pregunta 6}
\label{sec:orgae50956}

En la Sección \hyperref[sec:org1231ebc]{Datos en nivel del consumo de petroleo en Grecia}
aparecen dos modelos univariantes. Compare los resultados he indique
si alguno de ellos es preferible y por qué.

(\hyperref[sec:orgae98d40]{Respuesta 6})
\subsection*{Pregunta 7}
\label{sec:org42e72da}

En la Sección \hyperref[sec:org0dce84b]{Datos en nivel de la popularidad del nombre Óscar en EEUU} aparecen dos modelos univariantes. Compare los resultados he
indique si alguno de ellos es preferible y por qué.

(\hyperref[sec:org42e72da]{Pregunta 7})
\subsection*{Pregunta 8}
\label{sec:orgf7049ac}

¿Cuáles de los modelos de más arriba considera aceptables? ¿O qué
mejoras sugeriría para ellos?

(\hyperref[sec:org68ae17b]{Respuesta 8})

\newpage
\section*{Respuestas}
\label{sec:orgc1b2be4}

\subsection*{Respuesta 1}
\label{sec:org374e8e9}
...
\item \hyperref[sec:org462e39e]{Estimación de un primer modelo univariante para la serie de consumo de petroleo}: El modelo univariante estimado tiene una raíz AR
aproximadamente igual a \(1\).

\item \hyperref[sec:orgd2e892a]{Estimación de un primer modelo univariante para la serie de popularidad del nombre Óscar}: El modelo univariante estimado tiene
una raíz AR aproximadamente igual a \(1\).

\item \hyperref[sec:orgaed05fc]{Contraste de cointegración}: Los test ADF calculados en las etapas 1
y 2 no rechazan la hipótesis (raíz unitaria) con p-valores
superiores al 0.4
\end{itemize}

(\hyperref[sec:org2b72ce9]{Pregunta 1})
\subsection*{Respuesta 2}
\label{sec:orgebd9f8b}
...
(\hyperref[sec:org9102b43]{Pregunta 2})
\subsection*{Respuesta 3}
\label{sec:org84d1472}
...
Sorprendentemente, en la \hyperref[sec:org5b16206]{Regresión en primeras diferencias} la
...
decir, \uline{la \hyperref[sec:org5b16206]{Regresión en primeras diferencias} no contradice la
...
(\hyperref[sec:org7c844dc]{Pregunta 3})
\subsection*{Respuesta 4}
\label{sec:org860031e}
...
\begin{description}
\item[{Segundo modelo para datos en primeras diferencias}] (\hyperref[sec:org5b16206]{Regresión en primeras diferencias}): El segundo modelo incluye un nuevo regresor
...
(\hyperref[sec:org4fe6f95]{Pregunta 5})
\subsection*{Respuesta 6}
\label{sec:orgae98d40}
...
(\hyperref[sec:orgae50956]{Pregunta 6})
\subsection*{Respuesta 7}
\label{sec:orgad6fa20}
...
(\hyperref[sec:orgf7049ac]{Pregunta 8})
\end{document}
