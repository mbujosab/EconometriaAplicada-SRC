...
\end{verbatim}
\section*{Preguntas}
\label{sec:orgf44b0cc}

\subsection*{Pregunta 1}
\label{sec:org6255f49}
...
los resultados de los apartados \hyperref[sec:org707445b]{Datos en nivel de la serie de mortalidad} y \hyperref[sec:org7b924cb]{Contraste de cointegración}.

(\hyperref[sec:org51d1aa2]{Respuesta 1})
\subsection*{Pregunta 2}
\label{sec:orgd5bc258}
...
apartado \hyperref[sec:org7b924cb]{Contraste de cointegración}.

(\hyperref[sec:orgb5b4964]{Respuesta 2})
\subsection*{Pregunta 3}
\label{sec:org13fc090}

Sin embargo, ¿qué sugieren los resultados de las secciones \hyperref[sec:org459e064]{Regresión de la mortalidad sobre la proporción de matrimonios eclesiásticos} y
\hyperref[sec:orgc1eb125]{Regresión en primeras diferencias} respecto a la relación entre
\texttt{Std\_mortality} y \texttt{Proportion\_marriages}?

(\hyperref[sec:orgb023825]{Respuesta 3})
\subsection*{Pregunta 4}
\label{sec:orgc08f6f5}

Los listados en \hyperref[sec:org459e064]{Regresión de la mortalidad sobre la proporción de matrimonios eclesiásticos} y \hyperref[sec:orgc1eb125]{Regresión en primeras diferencias} muestran
...
(\hyperref[sec:org9fe344e]{Respuesta 4})
\subsection*{Pregunta 5}
\label{sec:orgcefdd58}

Interprete la pendiente de la regresión cointegrante estimada en la
Etapa 3 del \hyperref[sec:org7b924cb]{Contraste de cointegración}.

(\hyperref[sec:orgd9c86bf]{Respuesta 5})
\subsection*{Pregunta 6}
\label{sec:orgc028b68}

Indique cuáles de las siguientes expresiones representan el modelo de
la sección \hyperref[sec:org479a248]{Estimación de un modelo univariante para la serie de mortalidad}, con un redondeo a tres decimales 
...
\begin{description}
\item[{Modelo de regresión MCO para datos en nivel}] (\hyperref[sec:org459e064]{Regresión de la mortalidad sobre la proporción de matrimonios eclesiásticos}): Todos
...
\item[{Modelo para datos en primeras diferencias}] (\hyperref[sec:orgc1eb125]{Regresión en primeras diferencias}): El único coeficiente significativo es el término
...
(\hyperref[sec:orgc08f6f5]{Pregunta 4})
\subsection*{Respuesta 5}
\label{sec:orgd9c86bf}
...
(\hyperref[sec:orgcefdd58]{Pregunta 5})
\subsection*{Respuesta 6}
\label{sec:org3869369}
...
(\hyperref[sec:orgc028b68]{Pregunta 6})
\subsection*{Respuesta 7}
\label{sec:orgaa45764}
...
(\hyperref[sec:orgc06d639]{Pregunta 7})
\subsection*{Respuesta 8}
\label{sec:org2b451dd}
...
(\hyperref[sec:orga6067c5]{Pregunta 8})
\end{document}
