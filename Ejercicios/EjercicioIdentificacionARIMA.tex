...
\label{sec:org1b92a63}

\begin{enumerate}
\item \hyperref[sec:org80ee06c]{Realice un primer análisis gráfico: haga
un gráfico de la serie y un gráfico \emph{rango-media}}
\item \hyperref[sec:org7036df9]{Determine si es necesario transformar logarítmicamente los datos}
\item \hyperref[sec:org69b2d33]{Determine si es necesario tomar una o
más diferencias regulares de la serie}
\item \hyperref[sec:org40fef17]{Determine si es necesario tomar una
diferencia estacional de la serie}
\item \hyperref[sec:org1a99f06]{Encuentre un modelo ARIMA para la
...
\label{sec:org6afd43a}

Veamos si ese es el modelo usado en su simulación. Si miramos la línea
\texttt{37} del fichero \href{IdentificaEstosARIMA/Etiquetas-12.txt}{Etiquetas-12.txt} que se encuentra en el directorio de
...
\textbf{\uline{Ahora escoja al azar nuevas series del \href{IdentificaEstosARIMA/}{directorio} (dispone de
