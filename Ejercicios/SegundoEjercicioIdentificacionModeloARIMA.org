...
rm -fr $(pwd)/SegundoEjercicioIdentificacionModeloARIMA
mkdir -p $(pwd)/SegundoEjercicioIdentificacionModeloARIMA 
gretlcli -b /home/marcos/SynologyDrive/ReposGH/Docencia/EconometriaAplicada-SRC/EjerciciosHide/SegundoEjercicioIdentificacionModeloARIMA.inp
#+END_SRC

#+BEGIN_SRC sh  :exports none :results silent
zip mortality SegundoEjercicioIdentificacionModeloARIMA* SegundoEjercicioIdentificacionModeloARIMA/*
#+END_SRC


#+begin_src R :tangle SegundoEjercicioIdentificacionModeloARIMA.inp :exports none :results silent
# para que gretl guarde los ficheros en el directorio de la práctica
string directory = $(pwd) ~ "/SegundoEjercicioIdentificacionModeloARIMA" 
...
#+begin_src R :tangle SegundoEjercicioIdentificacionModeloARIMA.inp :results none :exports code 
...
[[./SegundoEjercicioIdentificacionModeloARIMA/SerieEnNiveles.png]]
#+ATTR_LATEX: :width 0.4\textwidth :center
[[./SegundoEjercicioIdentificacionModeloARIMA/rango-media.png]] 
#+END_CENTER
...
[[./SegundoEjercicioIdentificacionModeloARIMA/SerieEnNiveles.png]]
#+ATTR_LATEX: :width 0.5\textwidth :center 
[[./SegundoEjercicioIdentificacionModeloARIMA/x_ACF-PACF.png]]
#+END_CENTER
...
#+begin_src R :tangle SegundoEjercicioIdentificacionModeloARIMA.inp :results none :exports none :noweb yes
outfile --quiet ARIMA000x100.txt
  <<Modelo ARIMA_000x100 con cte>>
end outfile
#+end_src

#+include: ./SegundoEjercicioIdentificacionModeloARIMA/ARIMA000x100.txt example
...
#+BEGIN_CENTER
#+ATTR_LATEX: :width 0.5\textwidth :center 
[[./SegundoEjercicioIdentificacionModeloARIMA/SerieEnDiferencias.png]]
#+END_CENTER
...
#+BEGIN_CENTER
#+ATTR_LATEX: :width 0.5\textwidth :center 
[[./SegundoEjercicioIdentificacionModeloARIMA/sd_x_ACF-PACF.png]]
#+END_CENTER
...
#+include: ./SegundoEjercicioIdentificacionModeloARIMA/ARIMA110.txt example
...
#+include: ./SegundoEjercicioIdentificacionModeloARIMA/test_ADF_en_diff.txt example
...
#+include: ./SegundoEjercicioIdentificacionModeloARIMA/test_KPSS_en_diff.txt example
...
#+include: ./SegundoEjercicioIdentificacionModeloARIMA/ARIMA110cte.txt example
...
#+include: ./SegundoEjercicioIdentificacionModeloARIMA/ARIMA100x010.txt example
...
#+BEGIN_CENTER
#+ATTR_LATEX: :width 0.5\textwidth :center 
[[./SegundoEjercicioIdentificacionModeloARIMA/Residuos.png]]
#+ATTR_LATEX: :width 0.5\textwidth :center 
[[./SegundoEjercicioIdentificacionModeloARIMA/residuosACF-PACF.png]]
#+END_CENTER
...
#+include: ./SegundoEjercicioIdentificacionModeloARIMA/ResiduosACF-PACF.txt example
...
#+include: ./SegundoEjercicioIdentificacionModeloARIMA/ContrasteNormalidadResiduos.txt example
...
#+include: ./SegundoEjercicioIdentificacionModeloARIMA/ARIMAsimulado.txt example
