...
cp -a $(pwd)/SeriesSimuladas4/Etiquetas.txt $(pwd)/IdentificaEstosARIMA/Etiquetas-4.txt 
cp -a $(pwd)/SeriesSimuladas12/Etiquetas.txt $(pwd)/IdentificaEstosARIMA/Etiquetas-12.txt 
#+END_SRC
