...
El perfil de las series que se muestran en la \hyperref[sec:orgeb373e3]{figura anterior} sugiere que
ambas podrían estar cointegradas. Para estudiar esta posibilidad se
estiman:
\begin{itemize}
\item \hyperref[sec:org33bc01b]{modelos ARIMA} para las series \texttt{T4IPVN} y \texttt{T4IPV2M}, así como
\item \hyperref[sec:org267a710]{un modelo AR(1) para la serie \texttt{T4IPVN} con \texttt{T4IPV2M} y como input
exógeno}.
\end{itemize}
\section*{Modelos ARIMA}
\label{sec:org33bc01b}

\subsection*{Vivienda nueva}
\label{sec:org495795f}
...
\end{verbatim}
\section*{Preguntas}
\label{sec:org7147036}

\subsection*{Pregunta 1}
\label{sec:org8c2b7e5}

Comente exhaustivamente los resultados de estimación y diagnosis de
los \hyperref[sec:org33bc01b]{modelos ARIMA} estimados. 

(\hyperref[sec:org55f465f]{Respuesta 1})
\subsection*{Pregunta 2}
\label{sec:org3f77809}

Compare de todas las formas posibles los modelos \hyperref[sec:org33bc01b]{ARIMA} y \hyperref[sec:org267a710]{ARMAX} de la
...
caso del modelo \hyperref[sec:org267a710]{ARMAX})
\item cabe esperar que esté mejor especificado?
\end{itemize}

Argumente su respuesta de todas las formas posibles.

(\hyperref[sec:orgeed0629]{Respuesta 2})
\subsection*{Pregunta 3}
\label{sec:org27a1a6f}

\begin{enumerate}
\item Suponga que los modelos \hyperref[sec:org33bc01b]{ARIMA} (para \texttt{T4IPVN} y \texttt{T4IPV2M}) y \hyperref[sec:org267a710]{ARMAX}
...
\item Los \hyperref[sec:org00c134a]{intervalos de confianza de los parámetros estimados} ¿Introducen
algún matiz en su respuesta previa? ¿O no la afectan en absoluto?
\end{enumerate}

(\hyperref[sec:org8f38cf2]{Respuesta 3})
\subsection*{Pregunta 4}
\label{sec:orgfa2ce4b}

Indique cuáles de las siguientes expresiones representan el modelo \hyperref[sec:org33bc01b]{ARIMA} ajustado a \texttt{T4IPV2M} con un redondeo a tres decimales.
...
(\hyperref[sec:orgbae1f17]{Respuesta 4})
\end{description}
\subsection*{Pregunta 5}
\label{sec:orgb8d9a26}

Indique cuáles de las siguientes expresiones representan el modelo \hyperref[sec:org267a710]{ARMAX} ajustado a \texttt{T4IPVN} con un redondeo a tres decimales.
...
(\hyperref[sec:orgad1516c]{Respuesta 5})
\subsection*{Pregunta 6}
\label{sec:org062d9c1}

Indique si es cierta o no la siguiente afirmación:
\begin{quote}
El criterio de Akaike del modelo \hyperref[sec:org33bc01b]{ARIMA} ajustado a \texttt{T4IPV2M} es menor
que el del modelo \hyperref[sec:org33bc01b]{ARIMA} ajustado a \texttt{T4IPVN}, lo que indica que el
primer modelo probablemente predecirá fuera de la muestra mejor que el
segundo.
\end{quote}

(\hyperref[sec:org6b65f8d]{Respuesta 6})
\subsection*{Pregunta 7}
\label{sec:orgc0deb0e}

Indique si es cierta o no la siguiente afirmación:

\begin{quote}
La pendiente estimada de la variable \texttt{T4IPV2M} en el modelo \hyperref[sec:org267a710]{ARMAX}
...
(\hyperref[sec:org1f616b9]{Respuesta 7})
\subsection*{Pregunta 8}
\label{sec:orgccf161c}
...
(\hyperref[sec:orgfa2e097]{Respuesta 8})
\subsection*{Pregunta 9}
\label{sec:orgc9e9266}

Indique si es cierta o no la siguiente afirmación:

\begin{quote}
Los resultados que se muestran en la tabla de \hyperref[sec:org00c134a]{intervalos de confianza}
indican que debe rechazarse la hipótesis nula de que el parámetro
\(\phi_1\) sea igual a 1 con un 10\% de significación.
\end{quote}

(\hyperref[sec:orga3c1976]{Respuesta 9})
\subsection*{Pregunta 10}
\label{sec:org06e548a}
...
(\hyperref[sec:orga2f43c1]{Respuesta 10})
\section*{Respuestas}
\label{sec:orgbf4ab7d}

\subsection*{Respuesta 1}
\label{sec:org55f465f}
...
(\hyperref[sec:org8c2b7e5]{Pregunta 1})
\subsection*{Respuesta 2}
\label{sec:orgeed0629}


El modelo \hyperref[sec:org267a710]{ARMAX} se ajusta mejor la muestra ya que
\begin{itemize}
...
Por otra parte, los criterios de información del modelo \hyperref[sec:org267a710]{ARMAX} toman un
...
(\hyperref[sec:org3f77809]{Pregunta 2})
\subsection*{Respuesta 3}
\label{sec:org8f38cf2}
...
\begin{itemize}
\item los modelos \hyperref[sec:org33bc01b]{ARIMA} para las series \texttt{T4IPVN} y \texttt{T4IPV2M} son
...
\item el modelo \hyperref[sec:org267a710]{ARMAX} tiene un término de error estacionario, ya que la
...
\begin{enumerate}
\item Las estimaciones puntuales del modelo \hyperref[sec:org267a710]{ARMAX} sugieren que los
residuos son estacionarios. Sin embargo, al mirar los \hyperref[sec:org00c134a]{intervalos de
...
(\hyperref[sec:org27a1a6f]{Pregunta 3})
\subsection*{Respuesta 4}
\label{sec:orgbae1f17}
...
(\hyperref[sec:orgfa2ce4b]{Pregunta 4})
\subsection*{Respuesta 5}
\label{sec:orgad1516c}
...
(\hyperref[sec:orgb8d9a26]{Pregunta 5})
\subsection*{Respuesta 6}
\label{sec:org6b65f8d}
...
(\hyperref[sec:org062d9c1]{Pregunta 6})
\subsection*{Respuesta 7}
\label{sec:org1f616b9}
