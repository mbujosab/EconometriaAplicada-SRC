...
#+latex: \smallskip
 ...
 $\quad$ /(de [[eqref:eqYuleW3][(3)]] : $\gamma_0 =
   \frac{\sigma^2}{1-\phi_1\rho_1-\phi_2\rho_2}$ e iniciamos el
   cálculo  [[eqref:eqYuleW2][(2)]] recursivamente)/
...
#+latex:  $\quad$ \emph{(como $\rho_0=1$, iniciamos el cálculo \eqref{eqYuleW3} recursivamente)} \medskip
