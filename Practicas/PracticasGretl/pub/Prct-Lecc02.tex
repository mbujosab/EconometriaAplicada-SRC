...
\label{sec:org9335ee3}
\begin{center}
\begin{tabular}{ll}
Guión: & \href{https://github.com/mbujosab/Ectr/tree/master/Practicas/Gretl/scripts/componentesAirlinePass.inp}{componentesAirlinePass.inp}\\
\end{tabular}
\end{center}
