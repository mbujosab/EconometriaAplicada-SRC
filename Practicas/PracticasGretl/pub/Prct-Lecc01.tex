...
\label{sec:orgec1ce73}
\begin{center}
\begin{tabular}{ll}
Guión: & \href{https://github.com/mbujosab/Ectr/tree/master/Practicas/Gretl/scripts/airlinePass.inp}{airlinePass.inp}\\
\end{tabular}
\end{center}
...
\label{sec:org82bcab0}
\begin{enumerate}
\item Scatter plot
\label{sec:org3e90ee9}
\begin{itemize}
