...
- [[file:./Ejercicios/EjercicioIdentificacionARIMA.html][Ejercicio de identificación de modelos ARIMA]]
  (Versión [[file:./Ejercicios/EjercicioIdentificacionARIMA.pdf][pdf]] para imprimir) --- [[https://github.com/mbujosab/EconometriaAplicada-SRC/tree/main/Ejercicios/IdentificaEstosARIMA][Directorio con más series simuladas_]]

- [[file:Ejercicios/SegundoEjercicioIdentificacionModeloARIMA.html][Segundo ejercicio de identificación de modelos ARIMA]]
  (Versión [[file:Ejercicios/SegundoEjercicioIdentificacionModeloARIMA.pdf][pdf]] para imprimir) --- [[https://github.com/mbujosab/EconometriaAplicada-SRC/tree/main/Ejercicios/IdentificaEstosARIMA][Directorio con más series simuladas_]]
