...
- [[file:Ejercicios/SegundoEjercicioIdentificacionModeloARIMA.html][Segundo ejercicio de identificación de modelos ARIMA]]
  (Versión [[file:Ejercicios/SegundoEjercicioIdentificacionModeloARIMA.pdf][pdf]] para imprimir) --- [[https://github.com/mbujosab/EconometriaAplicada-SRC/tree/main/Ejercicios/IdentificaEstosARIMA][_Directorio con más series simuladas_]]
