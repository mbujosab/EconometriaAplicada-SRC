...
def repr_png(tex, ImgFile):
    ...
    # Crear el directorio si no existe y asegurarse de que tiene permisos de escritura
    img_dir = os.path.dirname(ImgFile)
    os.makedirs(img_dir, exist_ok=True)
    os.chmod(img_dir, 0o777)  # Cambiar permisos del directorio a 777 (lectura, escritura y ejecución para todos)
